...
function Login(){
      ...
      async function regesterStudent(e){
        e.preventDefault();
        try{
          const result = await fetch("/proxy/student-login",{    //hit in this link
  ...
  return (
  <>
  <div className="bg-cover bg-center h-screen flex justify-center items-center bg-[url('https://img.freepik.com/free-vector/christmas-theme-with-santa-snowman_1308-37932.jpg?t=st=1735008041~exp=1735011641~hmac=fc9436d06055bfc4a76e0bf9560ad3c758bf4c3ab78f6ca62a4136de26c7c6cb&w=1060')] ">
     <form onSubmit={regesterStudent} className='bg-gray-800/40 p-5 w-[600px] rounded-2xl backdrop-blur-sm  '>
      ...
      <button className='bg-red-500 p-2 hover:bg-red-400 text-white font-bold rounded-full text-3xl w-full 'type='submit' > Sign Up</button>
